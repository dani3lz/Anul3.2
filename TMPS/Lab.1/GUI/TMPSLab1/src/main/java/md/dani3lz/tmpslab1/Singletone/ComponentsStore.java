    ...
    public void setComponents(int nr, String type, String corporation){
        if(type.equalsIgnoreCase("Factory")) {
            try {
                ...
                if (nr == 1) {
                    new md.dani3lz.tmpslab1.Factory.CPUFactory().createComponent(corporationLocal, model, year, rank, price);
                } else if (nr == 2) {
                    new md.dani3lz.tmpslab1.Factory.GPUFactory().createComponent(corporationLocal, model, year, rank, price);
                } else if (nr == 3) {
                    new md.dani3lz.tmpslab1.Factory.RAMFactory().createComponent(corporationLocal, model, year, rank, price);
                }
                System.out.println("\n\nSuccessfully.");
            } catch (Exception e){
                e.printStackTrace();
